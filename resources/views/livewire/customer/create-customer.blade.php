<x-modal form-action="submit">
    ...
    <fieldset class="border-2 border-double border-gray-200 p-4 rounded-md">
        <legend class="px-2">Auth Credentials</legend>
        <!-- Name -->
        <div>
            <x-input-label for="name" :value="__('Username')" />
            <x-text-input wire:model="name" id="name" class="block mt-1 w-full bg-gray-100" type="text" name="name"
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model="email" id="email" class="block mt-1 w-full bg-gray-100" type="email" name="email" readonly/>
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model="password" id="password" class="block mt-1 w-full bg-gray-100" type="password" name="password"
