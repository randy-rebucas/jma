                ...
                <section>
                    ...
                    <div class="mt-6 space-y-6">
                        ...
                        <form wire:submit="save" class="w-full" id="myTabContent">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg dark:bg-gray-800 hidden" id="register"
                                ...
                                <div class="md:flex mb-2">
                                    ...
                                    <div class="md:w-2/3">
                                        <x-select wire:model="setting.receiving_register_mode"
                                            id="receiving_register_mode" name="receiving_register_mode"
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg dark:bg-gray-800 hidden" id="settings"
