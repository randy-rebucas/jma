                                ...
                                <x-table.tbody class="dark:border-gray-500">
                                    @forelse ($items as $item)
                                        <x-table.row class=" dark:bg-gray-700 dark:text-white"
                                            ...
                                            <x-table.tbody-cell :item="$item->sale_payment->payment_type" class="uppercase" />
                                            <x-table.tbody-cell :item="number_format($item->sale_payment->payment_amount, 2)" class="text-right" />
                                        </x-table.row>
                                    @empty
