...
<body class="antialiased">
    <div
        class="flex-col relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center  dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="bottom-0 fixed gap-6 py-2 flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
